...
function Home() {
    ...
    document
        ...
        ?.setAttribute(
            'content',
            'Portfolio de Stéphanie Bertaudeau, développeur web, qui vous propose la meilleure solution technique optimisée et sécurisée pour vos applications Web adaptée à vos besoins'
        );
            ...
            <HelmetProvider>
                <LanguageContext.Provider value={[language, setLanguage]}>
                    <DarkModeContext.Provider value={{ darkMode, setDarkMode }}>
                        <Seo
                            title='Stéphanie Bertaudeau, développeur Web'
                            description='Portfolio de Stéphanie Bertaudeau, développeur web, qui vous propose la meilleure solution technique optimisée et sécurisée pour vos applications Web adaptée à vos besoins'
                            image='http://assets/myWebsite_project.png'
                            imageAlt='website Home'
                            name=''
                            url=''
                        />
                        <BtnMenu />
                        ...
                        <main
                            id='arrowTop'
                            className={darkMode === 'true' ? 'dark-mode' : ''}
                        >
                            ...
                            <section className='techstack'>
                                ...
                                <div className='techstack__tags'>
                                    {data[language]?.tagTechStack &&
                                        data[language]?.tagTechStack.map(
                                            (tag, index) => (
                                                <Tag
                                                    tag={tag}
                                                    key={index}
                                                    className='techstack__tags-tag'
                                                />
                                            )
                                        )}
                                </div>
                            ...
                            <section className='skills'>
                                ...
                                <div className='skills__tags'>
                                    {data[language]?.tagSkills &&
                                        data[language]?.tagSkills.map(
                                            (tag, index) => (
                                                <Tag
                                                    tag={tag}
                                                    key={index}
                            ...
                            <article className='gallery'>
                                <h2>
                                    <Title
                                        content={data[language]?.gallery_title}
                                    />
                                </h2>
                                    ...
                                    {isLoading ? (
                                        ...
                                        dataSort.map((project) =>
                                            dataSort.length - project.id < 3 ? (
                                                <div
                                                    className='portfolio_done__gallery-card'
                                                    key={project.id}
                                                >
                                                    <Link
