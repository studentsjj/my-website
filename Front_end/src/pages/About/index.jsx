                    ...
                    <DarkModeContext.Provider value={{ darkMode, setDarkMode }}>
                        ...
                        >
                            ...
                            >
                                <h1>
                                    <Title
                                        content={data[language]?.about_title}
                                    />
                                </h1>
                                <ArrowRight />
                                <span>2022-2023</span>
                                ...
                                <Masonry
                                    breakpointCols={2}
                                    className='ecole42'
                                    columnClassName='ecole42_column'
                                >
                                    <img src={ecole42} alt='' />
                            ...
                            >
                                ...
                                {data[language]?.about_soft_skills &&
                                    data[language]?.about_soft_skills.map(
                                        (tag, index) => (
                                            <Tag
                                                tag={tag}
                                                key={index}
                                                className='softSkills__tags-tag'
                                            />
                                        )
                                    )}
                                <ArrowLeft />
                            ...
                            >
                                ...
                                <div className='hardSkills__icon'>
                                    <Masonry
                                        breakpointCols={3}
                                        className='hardSkills__icon-column'
                                    >
                                        <img
                                            className='html'
                                            src={htmlIcon}
